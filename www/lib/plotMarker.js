    ...
    constructor(tle) {
        ...
        */
        this.drawLabel = function (ctx, canvasRect, pos) {
            ...
            if (m_labelOrientation == Static.Vertical)
                painter.drawVerticalText(m_label,
                    textRect.left() + textSize.height * 0.3, textRect.bottom() - textSize.width * 0.75);
            else
                painter.drawText(m_label, textRect.left(), textRect.bottom() - 2);
            //painter.restore();
        ...
        */
        this.drawLines = function (ctx, canvasRect, pos) {
            ...
            if (m_style == PlotMarker.LineStyle.HLine || m_style == PlotMarker.LineStyle.Cross) {
                var y = pos.y;
                //if ( doAlign )
                //y = qRound( y );
            ...
            if (m_style == PlotMarker.LineStyle.VLine || m_style == PlotMarker.LineStyle.Cross) {
                var x = pos.x;
                //if ( doAlign )
                //x = qRound( x );
