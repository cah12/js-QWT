...
class SpectroCurve extends PlotSeriesItem {
    constructor(tle) {
        ...
        this.rtti = Static.Rtti_PlotSpectroCurve;
        //var m_colorMap = new LinearColorMap();
        //var m_colorMap = new LinearColorMap(RGB);
        var m_colorMap = new LinearColorMap(INDEXED);
        ...
        this.drawDots = function (painter, xMap, yMap, /*canvasRect,*/ from, to) {
                ...
                /*if ( d_data->paintAttributes & QwtPlotSpectroCurve::ClipPoints )
            {
                ...
                if (format == RGB) {
                    ...
                    painter.setPen(new Misc.Pen(Static.RGB2HTML(rgb), m_penWidth))
                    painter.setBrush(new Misc.Brush(Static.RGB2HTML(rgb)));
                    //RGB2HTML(0,0,255)
                    //
                } else {
                    ...
                    painter.setPen(new Misc.Pen(Static.RGB2HTML(color), m_penWidth))
                    painter.setBrush(new Misc.Brush(Static.RGB2HTML(color)));
                }
